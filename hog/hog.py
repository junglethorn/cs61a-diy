...
def picky_piggy(score):
    ...
    elif score%6==1:return 1
    elif score%6==2:return 4
    elif score%6==3:return 2
    elif score%6==4:return 8
    elif score%6==5:return 5
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided, goal=GOAL_SCORE):
    ...
    # BEGIN PROBLEM 3
    "*** YOUR CODE HERE ***"
    if num_rolls==0:return picky_piggy(opponent_score)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score1<goal and score0<goal: 
        if who==0:
            aa=strategy0(score0,score1)
            ss=take_turn(aa,score1,dice,goal)
            score0+=ss+hog_pile(score1,score0+ss)
        else:
            aa=strategy1(score1,score0)
            ss=take_turn(aa,score0,dice,goal)
            score1+=ss+hog_pile(score0,score1+ss)
        who=next_player(who)
        # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        if who==0:
            ...
            return announce_highest(who,score0,max(running_high,score0-last_score))
        else:
            if score1-last_score>running_high:
                print(score1-last_score,"point(s)! That's a record gain for Player 1!")
            return announce_highest(who,score1,max(running_high,score1-last_score))
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    ma=0
    for i in range(1,11):
        aa=make_averaged(roll_dice,trials_count)
        bb=aa(i,dice)
        if(bb>ma):
            ma=bb
            ans=i
...
def picky_piggy_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    if picky_piggy(opponent_score)>=cutoff:return 0
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if hog_pile(score+picky_piggy(opponent_score),opponent_score)!=0:return 0
    else: return picky_piggy_strategy(score,opponent_score,cutoff,num_rolls)
    # END PROBLEM 11
